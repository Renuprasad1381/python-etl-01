...
TABLE = "orderdetails"
ORDERDETAILS_COL = os.getenv("orderdetailsColumn")
...
# ============================================================
# Load data from S3 → Redshift (with column mapping)
# ============================================================
def load_s3_to_redshift():
    ...
    try:
        ...
        # Step 2: Use explicit column list to match CSV header order
        copy_sql = f"""
            COPY {REDSHIFT_SCHEMA}.{TABLE} ({ORDERDETAILS_COL})
            FROM '{s3_path}'
