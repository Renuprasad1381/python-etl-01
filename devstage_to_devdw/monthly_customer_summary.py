...
def load_monthly_customer_summary():
    """Aggregate daily_customer_summary data into monthly_customer_summary table."""
    etl_batch_no, etl_batch_date = get_batch_date_from_redshift()
    conn = get_redshift_connection()
    cur = conn.cursor()

    print(" Running monthly aggregation and merge into monthly_customer_summary...")

    sql = f"""
        -- ========================
        -- Step 1: UPDATE existing records
        -- ========================
        UPDATE j25renu_devdw.monthly_customer_summary AS m
        SET
        ...
        FROM (
            ...
            FROM j25renu_devdw.daily_customer_summary
        ...
        -- ========================
        INSERT INTO j25renu_devdw.monthly_customer_summary (
        ...
        LEFT JOIN j25renu_devdw.monthly_customer_summary AS m
    ...
    cur.execute(sql)
    print(" Monthly customer summary successfully updated and inserted.")
